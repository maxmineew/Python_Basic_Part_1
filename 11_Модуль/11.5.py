...
RadiusXPlanet = float(input('Введите радиус случайной планеты: '))

earth = 10.8321 * 10 ** 11
XPlanet = (4 / 3 * math.pi * RadiusXPlanet ** 3)

if XPlanet < earth:
    difference = round(1 / (XPlanet * 1 / earth), 3)

    print('Объём планеты Земля больше в', difference, 'раз')
elif XPlanet > earth:
    difference = round(1 / (XPlanet * 1 / earth), 3)
    print('Объём планеты Земля меньше в (1/0,754) =', round(1 / difference, 3), 'раз')
else:
    XPlanet == earth
