...
file = int(input('Укажите размер файла для скачивания:' )) # 123
speed = int(input('Какова скорость вашего соединения?' )) # 27
print()
for sec in range(speed):
  file += file
  print('прошло', sec + 1, 'сек.', 'скачано', file, 'из', file, 'Мб')
